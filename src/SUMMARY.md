...
[학습 개요](./00_overview.md)

# Part 1. 정리하지 않는 기록 시스템

- [1. Second Brain은 왜 유지되지 않는가](./01_second_brain_failure_modes.md)
- [2. Obsidian을 Agent용 로컬 지식 DB로 보기](./02_obsidian_as_local_knowledge_db.md)
- [3. Daily Note를 Capture Protocol로 설계하기](./03_daily_note_capture_protocol.md)

# Part 2. Archive Agent 설계
...
- [B. 소스 맵](./appendix_b_source_map.md)
- [C. 용어집](./appendix_c_glossary.md)
